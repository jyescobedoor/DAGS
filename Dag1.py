...
# DAG principal
with DAG('dag_principal', start_date=datetime(2024, 7, 1, 00, 00, 00, tzinfo=local_tz), schedule_interval='5,15,25,35,45,55 * * * *',catchup=False,) as dag1:
...
# DAG dependiente
with DAG('dag_dependiente', start_date=datetime(2024, 7, 1, 00, 00, 00, tzinfo=local_tz), schedule_interval='00,10,20,30,40,50 * * * *',catchup=False,) as dag2:
