...
# DAG principal
with DAG('dag_principal', start_date=datetime(2024, 7, 1, 00, 00, 00, tzinfo=local_tz), schedule_interval='14 * * * *',catchup=False,) as dag1:
...
# DAG dependiente
with DAG('dag_dependiente', start_date=datetime(2024, 7, 1, 00, 00, 00, tzinfo=local_tz), schedule_interval='14 * * * *',catchup=False,) as dag2:
